 ...
 */
void TrainingData::readImageDataVectorFromFile(std::string& file_name) {
 ...
 * @param file_name the file name to be read from.
 */
void TrainingData::readImageLabelFromFile(std::string& file_name) {
 ...
 */
std::vector<ImageData>& TrainingData::getImageDataVector() {
 ...
 */
std::vector<int>& TrainingData::getImageLabelVector() {
